...
export default function Page() {
    ...
    const refreshPage = async () => {
        try {
            let res = await fetch(`${process.env.remote_connection || process.env.local_connection}/scrape/page`, {
                method: 'POST',
                headers: {
            ...
            if (res.status === 401) {
                ...
                if (refreshRes.ok) {
                    res = await fetch(`${process.env.remote_connection || process.env.local_connection}/scrape/page`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    const downloadCsv = async () => {
        try {
            let res = await fetch(`${process.env.remote_connection || process.env.local_connection}/scrape/download`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (res.status === 401) {
                ...
                if (refreshRes.ok) {
                    res = await fetch(`${process.env.remote_connection || process.env.local_connection}/scrape/download`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    const downloadZip = async (id: number) => {
        ...
        try {
            let res = await fetch(`${process.env.remote_connection || process.env.local_connection}/scrape/zip`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (res.status === 401) {
                ...
                if (refreshRes.ok) {
                    res = await fetch(`${process.env.remote_connection || process.env.local_connection}/scrape/zip`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
